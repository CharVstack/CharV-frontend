var N=Object.defineProperty;var t=(r,e)=>N(r,"name",{value:e,configurable:!0});import{j as i}from"./jsx-runtime-b19c866b.js";import{B as O}from"./Backdrop-f22d0f8f.js";import{g as d,_ as n,f as z}from"./defaultTheme-968d66a4.js";import{r as B}from"./index-f47a0ae4.js";import{a as E,g as T,s as v,c as A,b as K}from"./styled-e2b1244e.js";import{u as U}from"./useThemeProps-6d10ab63.js";import{k as R,c as D}from"./emotion-react.browser.esm-70e32f24.js";function j(r){return E("MuiCircularProgress",r)}t(j,"getCircularProgressUtilityClass");T("MuiCircularProgress",["root","determinate","indeterminate","colorPrimary","colorSecondary","svg","circle","circleDeterminate","circleIndeterminate","circleDisableShrink"]);const F=["className","color","disableShrink","size","style","thickness","value","variant"];let p=t(r=>r,"_"),P,b,L,$;const o=44,V=R(P||(P=p`
  0% {
...
`)),Y=t(r=>{const{classes:e,variant:s,color:a,disableShrink:m}=r,u={root:["root",s,`color${d(a)}`],svg:["svg"],circle:["circle",`circle${d(s)}`,m&&"circleDisableShrink"]};return K(u,j,e)},"useUtilityClasses"),q=v("span",{name:"MuiCircularProgress",slot:"Root",overridesResolver:(r,e)=>{const{ownerState:s}=r;return[e.root,e[s.variant],e[`color${d(s.color)}`]]}})(({ownerState:r,theme:e})=>n({display:"inline-block"},r.variant==="determinate"&&{transition:e.transitions.create("transform")},r.color!=="inherit"&&{color:(e.vars||e).palette[r.color].main}),({ownerState:r})=>r.variant==="indeterminate"&&D(L||(L=p`
    ...
    `),W)),H=B.exports.forwardRef(t(function(e,s){const a=U({props:e,name:"MuiCircularProgress"}),{className:m,color:u="primary",disableShrink:w=!1,size:f=40,style:I,thickness:c=3.6,value:g=0,variant:C="indeterminate"}=a,M=z(a,F),l=n({},a,{color:u,disableShrink:w,size:f,thickness:c,value:g,variant:C}),h=Y(l),S={},y={},x={};if(C==="determinate"){const _=2*Math.PI*((o-c)/2);S.strokeDasharray=_.toFixed(3),x["aria-valuenow"]=Math.round(g),S.strokeDashoffset=`${((100-g)/100*_).toFixed(3)}px`,y.transform="rotate(-90deg)"}return i(q,n({className:A(h.root,m),style:n({width:f,height:f},y,I),ownerState:l,ref:s,role:"progressbar"},x,M,{children:i(G,{className:h.svg,ownerState:l,viewBox:`${o/2} ${o/2} ${o} ${o}`,children:i(Z,{className:h.circle,style:S,ownerState:l,cx:o,cy:o,r:(o-c)/2,fill:"none",strokeWidth:c})})}))},"CircularProgress")),J=H,k=t(({open:r})=>i(O,{sx:{color:e=>e.palette.common.white,zIndex:e=>e.zIndex.drawer+1},open:r,children:i(J,{color:"inherit"})}),"LoadingSpinner");try{k.displayName="LoadingSpinner",k.__docgenInfo={description:"",displayName:"LoadingSpinner",props:{open:{defaultValue:null,description:"",name:"open",required:!0,type:{name:"boolean"}}}},typeof STORYBOOK_REACT_CLASSES<"u"&&(STORYBOOK_REACT_CLASSES["src/components/molecules/Progress/Circular/LoadingSpinner.tsx#LoadingSpinner"]={docgenInfo:k.__docgenInfo,name:"LoadingSpinner",path:"src/components/molecules/Progress/Circular/LoadingSpinner.tsx#LoadingSpinner"})}catch{}export{J as C,k as L};
//# sourceMappingURL=LoadingSpinner-7be6b725.js.map
